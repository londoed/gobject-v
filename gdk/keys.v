const (
	KEY_void_symbol                  = uint(C.GDK_KEY_VoidSymbol)
	...
	KEY_single_candidate             = uint(C.GDK_KEY_SingleCandidate)
	KEY_multiple_candidate           = uint(C.GDK_KEY_MultipleCandidate)
	KEY_previous_candidate           = uint(C.GDK_KEY_PreviousCandidate)
